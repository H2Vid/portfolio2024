...
const Experience = () => {
  ...
  return (
    <>
      <div className="flex py-20 space-y-10 mx-auto flex-col lg:flex-row lg:mx-32 lg:justify-between lg:space-y-0 dark:text-white text-[#010101]">
            ...
            return (
              <Accordion.Panel key={i}>
                <div className="border-none p-1">
                  <Accordion.Title className="border p-2 px-4 text-sm rounded-sm">{data.questionExperience}</Accordion.Title>
                </div>
                      ...
                      return (
                        <div key={index} className="w-full flex items-center space-x-3">
                          <div className="relative h-[200px] w-[75%] lg:w-[300px] mb-5 lg:mb-0 space-x-5">
                            <Image src={proof.foto} className="border rounded-xl p-2 text-sm relative" fill alt="certificate" priority></Image>
                          </div>
