      ...
      <div className='flex flex-col items-center justify-center'>
        ...
        <div className='flex space-x-5 justify-center'>
          <a href='/cv/cv.pdf' download={true}>
            <button className='bg-[#368B85] px-5 py-2 mt-6 lg:mt-12 rounded-lg shadow-md text-white font-semibold'>
              Download My CV
            </button>
          </a>
          <button
            onClick={toggleDarkMode}
            className='bg-[#368B85] px-5 py-2 mt-6 lg:mt-12 rounded-lg shadow-md text-white font-semibold'
          >
