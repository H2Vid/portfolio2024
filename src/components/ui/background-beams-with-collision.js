...
export const BackgroundBeamsWithCollision = ({ children, className }) => {
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-[80vh] bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-800 dark:to-neutral-950 relative flex items-center w-full justify-center overflow-hidden",
